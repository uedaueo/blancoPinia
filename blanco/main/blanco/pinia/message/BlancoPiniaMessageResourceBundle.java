...
/**
 * A resource bundle class used internally by the message definition [BlancoPinia].
 *
 * リソースバンドル定義: [BlancoPiniaMessage]。<BR>
 * このクラスはリソースバンドル定義書から自動生成されたリソースバンドルクラスです。<BR>
 */
class BlancoPiniaMessageResourceBundle {
    /**
     * リソースバンドルオブジェクト。
     *
    ...
    /**
     * BlancoPiniaMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoPiniaMessage]、デフォルトのロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     */
    public BlancoPiniaMessageResourceBundle() {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/pinia/message/BlancoPiniaMessage");
     ...
     * BlancoPiniaMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoPiniaMessage]、指定されたロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     */
    public BlancoPiniaMessageResourceBundle(final Locale locale) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/pinia/message/BlancoPiniaMessage", locale);
        } catch (MissingResourceException ex) {
        }
    }
     ...
     * BlancoPiniaMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoPiniaMessage]、指定されたロケール、指定されたクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     * @param loader クラスローダの指定
     */
    public BlancoPiniaMessageResourceBundle(final Locale locale, final ClassLoader loader) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/pinia/message/BlancoPiniaMessage", locale, loader);
        } catch (MissingResourceException ex) {
        }
    }
    ...
    /**
     * bundle[BlancoPiniaMessage], key[MBVOJI01]
     *
    ...
    /**
     * bundle[BlancoPiniaMessage], key[MBVOJI02]
     *
    ...
    /**
     * bundle[BlancoPiniaMessage], key[MBVOJI03]
     *
    ...
    /**
     * bundle[BlancoPiniaMessage], key[MBVOJI04]
     *
    ...
    /**
     * bundle[BlancoPiniaMessage], key[MBVOJI05]
     *
    ...
    /**
     * bundle[BlancoPiniaMessage], key[MBVOJI06]
     *
    ...
    /**
     * bundle[BlancoPiniaMessage], key[MBVOJI07]
     *
    ...
    /**
     * bundle[BlancoPiniaMessage], key[MBVOJI08]
     *
    ...
    /**
     * bundle[BlancoPiniaMessage], key[MBVOJA01]
     *
