...
/**
 * VueStore Gettersのフィールドをあらわすバリューオブジェクトクラス。このクラスの設定情報をもとにフィールドとセッター・ゲッターが自動生成されます。
 */
public class BlancoPiniaGettersStructure {
    /**
     * 項目番号。省略可能です。
     *
     * フィールド: [no]。
    ...
    public String toString() {
        ...
        buf.append("blanco.pinia.valueobject.BlancoPiniaGettersStructure[");
        buf.append("no=" + fNo);
     ...
     */
    public void copyTo(final BlancoPiniaGettersStructure target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: BlancoPiniaGettersStructure#copyTo(target): argument 'target' is null");
        }
