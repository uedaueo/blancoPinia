...
public class BlancoPiniaUtil {
    ...
    static public void processValueObjects(final BlancoPiniaProcessInput input) throws IOException {
        if (isVerbose) {
    ...
    static private void searchTmpdir(String tmpdir) {
        ...
        final File[] fileMeta3 = new File(tmpdir
                + BlancoPiniaConstants.OBJECT_SUBDIRECTORY)
                .listFiles();
...
//        }
    ...
    static public String convertPhpType2Ts(String argPhpType, BlancoPiniaClassStructure argObjClassStructure, Map<String, List<String>> argHeaderList, boolean isGeneric) {
        ...
        if ("boolean".equalsIgnoreCase(argPhpType)) {
            ...
            BlancoValueObjectTsClassStructure voStructure = BlancoPiniaUtil.objects.get(argPhpType);
            ...
            if (voStructure != null) {
                ...
                if (packageName == null) {
                    ...
                    String simpleName = BlancoPiniaUtil.getSimpleClassName(argPhpType);
                    if (simpleName != null && !simpleName.equals(argPhpType)) {
                        packageName = BlancoPiniaUtil.getPackageName(argPhpType);
...
//                if (isVerbose) {
//                    System.out.println("convertPhpType2Ts: targetType = " + targetType);
//                    System.out.println("convertPhpType2Ts: packageName = " + packageName);
//                }
                ...
                if (argObjClassStructure.getCreateImportList()) {
                    BlancoPiniaUtil.makeImportHeaderList(packageName, argPhpType, argHeaderList, voStructure.getBasedir(), "");
                }
            }
        }
        return targetType;
