...
/**
 * VueStore Stateのフィールドをあらわすバリューオブジェクトクラス。このクラスの設定情報をもとにフィールドとセッター・ゲッターが自動生成されます。
 */
public class BlancoPiniaStateStructure {
    /**
     * 項目番号。省略可能です。
     *
     * フィールド: [no]。
    ...
    public String toString() {
        ...
        buf.append("blanco.pinia.valueobject.BlancoPiniaStateStructure[");
        buf.append("no=" + fNo);
     ...
     */
    public void copyTo(final BlancoPiniaStateStructure target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: BlancoPiniaStateStructure#copyTo(target): argument 'target' is null");
        }
